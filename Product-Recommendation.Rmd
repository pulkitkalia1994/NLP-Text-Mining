---
title: "NLP/Text Mining - Predicting product recommendation using model ensembling(Stacking)"
author: "Pulkit Kalia"
date: "19 August 2018"
...
### Synopsis
This dataset was taken from Kaggle and was used to predict if the product will be recommended.
Variable Title was taken and corpus was created using TM library and most frequent words were analysed and used for predictions.
Few new variables were also introduced after EDA which resulted in better ouput.
